...
const App = {
  ...
  async checkAuthStatus() {
    try {
      // In demo mode, simulate checking auth status
  ...
  // Handle user registration (demo mode)
  ...
  async handleAppointment(e) {
    ...
    try {
      ...
      this.showMessage(
        "appointment-message",
        `Appointment request submitted successfully! We'll contact you at ${data.phone} to confirm your ${data.service} appointment on ${data.date} at ${data.time}.`,
        "success",
      )
